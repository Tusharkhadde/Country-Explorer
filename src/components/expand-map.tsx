                  ...
                  <div className="grid grid-cols-2 gap-x-4 gap-y-3 pt-3 border-t border-border/50 text-xs">
                    {countryCode && (
                      <div className="flex flex-col">
                        <span className="text-muted-foreground/70 text-[10px] uppercase font-bold tracking-wider">Code</span>
                        <span className="text-foreground font-medium truncate">{countryCode}</span>
                      </div>
                    )}
                    {capital && (
                      <div className="flex flex-col">
                        <span className="text-muted-foreground/70 text-[10px] uppercase font-bold tracking-wider">Capital</span>
                        <span className="text-foreground font-medium truncate">{capital}</span>
                      </div>
                    )}
                    {currency && (
                      <div className="flex flex-col">
                        <span className="text-muted-foreground/70 text-[10px] uppercase font-bold tracking-wider">Currency</span>
                        <span className="text-foreground font-medium truncate">{currency}</span>
                      </div>
                    )}
                    {region && (
                      <div className="flex flex-col">
                        <span className="text-muted-foreground/70 text-[10px] uppercase font-bold tracking-wider">Region</span>
                        <span className="text-foreground font-medium truncate">{region}</span>
                      </div>
                    )}
                    {language && (
                      <div className="flex flex-col col-span-2">
                        <span className="text-muted-foreground/70 text-[10px] uppercase font-bold tracking-wider">Language</span>
                        <span className="text-foreground font-medium truncate">{language}</span>
                      </div>
                    )}
                  </div>
                </motion.div>
