            ...
            <main className="container mx-auto px-4 py-8 md:py-16">
                ...
                >
                    <motion.div
                        ...
                        className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#EDF3EC] text-[#346538] text-sm font-medium mb-6"
                    >
                    ...
                    <h1 className="text-4xl md:text-6xl font-bold mb-4">
                        Search by <span className="text-muted-foreground">Currency</span>
                    </h1>
                </motion.div>
